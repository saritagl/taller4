<input type="hidden" name="index" value="FALSE" />
	<?php if($index==1):?>
		<form id="login" action="/fecha/disponible" method="post">
		<input type="hidden" name="index" value="1" />
	<?php elseif($index==2):?>
		<form id="login" action="/fecha/hab_reservadas" method="post">
	...
	<div class="col s6 push-s3 pull-s3">
		...
		<div class="col s12">
			...
			<button class="btn waves-effect waves-light left" onClick="window.location.href='/login/inicio'" type="button">Cancelar
