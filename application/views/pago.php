<form class="col s8 push-s2 pull-s2" action="/fecha/confirmacion_pago" method="post">
	...
	<div class="input-field col s6">
		<input id="telef" type="text" class="validate" name="tlf" maxlength="11" value="<?php if (isset($_POST['tlf'])) echo $_POST['tlf']; ?>">
		<label for="telef">Teléfono</label>
	</div>
	<div class="input-field col s8">
		<input id="tarj" type="text" class="validate" name="tarj" maxlength="16" value="<?php if (isset($_POST['tarj'])) echo $_POST['tarj']; ?>">
		<label for="tarj">Número de Tarjeta</label>
	</div>
	<div class="input-field col s4">
		<input id="cod-tarj" type="text" class="validate" name="cod-tarj" maxlength="3" value="<?php if (isset($_POST['cod-tarj'])) echo $_POST['cod-tarj']; ?>">
